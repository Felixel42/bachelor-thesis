...
class InfuraGateway: 
    ...
    def transmitSmartMeterReading(self, time, reading):
        ...
        hexMethodTransaction = self.my_contract.encodeABI('updateWaterMeterValue', [time.tm_year, time.tm_mon, time.tm_mday, time.tm_hour, reading])
